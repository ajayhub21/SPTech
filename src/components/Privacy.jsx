    ...
    <div className="bg-gradient-to-b from-gray-100 to-gray-200 py-16 px-6">
      <div className="max-w-4xl mx-auto bg-white p-8 shadow-lg rounded-lg">
        ...
        <p className="text-gray-700 mb-4">
          ...
          we collect, use, and safeguard the data you share with us when using
        ...
        <ul className="list-disc pl-6 text-gray-700">
          <li>
            Personal Information: Name, contact information (email, phone
            number), and location details.
          </li>
          <li>
            Scanned Documents: Any information contained within the documents
            you provide for scanning.
          </li>
          <li>
            Technical Data: IP address, browser type, and usage data to improve
            our services.
          </li>
        </ul>
        ...
        <p className="text-gray-700">
          ...
          may share information with third parties when necessary to provide our
        ...
        <ul className="list-disc pl-6 text-gray-700">
          ...
          <li>
            Marketing Preferences: You can opt out of marketing communications
            at any time.
          </li>
        </ul>
